...
@dso_cache = dso_local local_unnamed_addr global [48 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1640489178274067760, ; hash 0x16c4303748e5f530, from name: libBugly
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 5607440479600625228, ; hash 0x4dd1a1681dbdc64c, from name: Bugly.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.0_name, ; name: libBugly.so
		ptr null; void* handle (0x0)
	}, ; 6
	...
	%struct.DSOCacheEntry {
		i64 8047369983927982664, ; hash 0x6fae005d142b1a48, from name: libBugly.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.0_name, ; name: libBugly.so
		ptr null; void* handle (0x0)
	}, ; 21
	...
	%struct.DSOCacheEntry {
		i64 18394745280098799948, ; hash 0xff47435f6a15114c, from name: Bugly
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.0_name, ; name: libBugly.so
		ptr null; void* handle (0x0)
	} ; 47
