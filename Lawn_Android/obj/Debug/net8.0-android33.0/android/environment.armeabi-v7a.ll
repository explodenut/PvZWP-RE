...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 204, ; uint32_t number_of_assemblies_in_apk (0xcc)
...
@dso_cache = dso_local local_unnamed_addr global [48 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 121273299, ; hash 0x73a7bd3, from name: libMono.Unix
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.11_name, ; name: libMono.Unix.so
		ptr null; void* handle (0x0)
	}, ; 1
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.1_name, ; name: libopenal32.so
		ptr null; void* handle (0x0)
	}, ; 11
	%struct.DSOCacheEntry {
		i64 1338932416, ; hash 0x4fce7cc0, from name: Mono.Unix.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.11_name, ; name: libMono.Unix.so
		ptr null; void* handle (0x0)
	}, ; 12
	...
	%struct.DSOCacheEntry {
		i64 1900624468, ; hash 0x71493a54, from name: Bugly
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.0_name, ; name: libBugly.so
		ptr null; void* handle (0x0)
	}, ; 19
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 1966065150, ; hash 0x752fc5fe, from name: Mono.Unix
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.11_name, ; name: libMono.Unix.so
		ptr null; void* handle (0x0)
	}, ; 21
	...
	%struct.DSOCacheEntry {
		i64 2271959572, ; hash 0x876b5a14, from name: libBugly
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.0_name, ; name: libBugly.so
		ptr null; void* handle (0x0)
	}, ; 27
	%struct.DSOCacheEntry {
		i64 2450643266, ; hash 0x9211d942, from name: Bugly.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.0_name, ; name: libBugly.so
		ptr null; void* handle (0x0)
	}, ; 28
	...
	%struct.DSOCacheEntry {
		i64 3423333178, ; hash 0xcc0beb3a, from name: libMono.Unix.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.11_name, ; name: libMono.Unix.so
		ptr null; void* handle (0x0)
	}, ; 37
	...
	%struct.DSOCacheEntry {
		i64 4122860339, ; hash 0xf5bddb33, from name: libBugly.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.0_name, ; name: libBugly.so
		ptr null; void* handle (0x0)
	}, ; 44
...
@_XamarinAndroidBundledAssembly_name_b3_b3 = internal dso_local global [66 x i8] zeroinitializer, align 1
@_XamarinAndroidBundledAssembly_name_b4_b4 = internal dso_local global [66 x i8] zeroinitializer, align 1
@_XamarinAndroidBundledAssembly_name_b5_b5 = internal dso_local global [66 x i8] zeroinitializer, align 1
@_XamarinAndroidBundledAssembly_name_b6_b6 = internal dso_local global [66 x i8] zeroinitializer, align 1
@_XamarinAndroidBundledAssembly_name_b7_b7 = internal dso_local global [66 x i8] zeroinitializer, align 1
@_XamarinAndroidBundledAssembly_name_b8_b8 = internal dso_local global [66 x i8] zeroinitializer, align 1
@_XamarinAndroidBundledAssembly_name_b9_b9 = internal dso_local global [66 x i8] zeroinitializer, align 1
@_XamarinAndroidBundledAssembly_name_ba_ba = internal dso_local global [66 x i8] zeroinitializer, align 1
@_XamarinAndroidBundledAssembly_name_bb_bb = internal dso_local global [66 x i8] zeroinitializer, align 1
@_XamarinAndroidBundledAssembly_name_bc_bc = internal dso_local global [66 x i8] zeroinitializer, align 1
@_XamarinAndroidBundledAssembly_name_bd_bd = internal dso_local global [66 x i8] zeroinitializer, align 1
@_XamarinAndroidBundledAssembly_name_be_be = internal dso_local global [66 x i8] zeroinitializer, align 1
@_XamarinAndroidBundledAssembly_name_bf_bf = internal dso_local global [66 x i8] zeroinitializer, align 1
@_XamarinAndroidBundledAssembly_name_c0_c0 = internal dso_local global [66 x i8] zeroinitializer, align 1
@_XamarinAndroidBundledAssembly_name_c1_c1 = internal dso_local global [66 x i8] zeroinitializer, align 1
@_XamarinAndroidBundledAssembly_name_c2_c2 = internal dso_local global [66 x i8] zeroinitializer, align 1
@_XamarinAndroidBundledAssembly_name_c3_c3 = internal dso_local global [66 x i8] zeroinitializer, align 1
@_XamarinAndroidBundledAssembly_name_c4_c4 = internal dso_local global [66 x i8] zeroinitializer, align 1
@_XamarinAndroidBundledAssembly_name_c5_c5 = internal dso_local global [66 x i8] zeroinitializer, align 1
@_XamarinAndroidBundledAssembly_name_c6_c6 = internal dso_local global [66 x i8] zeroinitializer, align 1
@_XamarinAndroidBundledAssembly_name_c7_c7 = internal dso_local global [66 x i8] zeroinitializer, align 1
@_XamarinAndroidBundledAssembly_name_c8_c8 = internal dso_local global [66 x i8] zeroinitializer, align 1
@_XamarinAndroidBundledAssembly_name_c9_c9 = internal dso_local global [66 x i8] zeroinitializer, align 1
@_XamarinAndroidBundledAssembly_name_ca_ca = internal dso_local global [66 x i8] zeroinitializer, align 1
@_XamarinAndroidBundledAssembly_name_cb_cb = internal dso_local global [66 x i8] zeroinitializer, align 1

; Bundled assembly name buffers, all 66 bytes long
@bundled_assemblies = dso_local local_unnamed_addr global [204 x %struct.XamarinAndroidBundledAssembly] [
...
@.env.7 = private unnamed_addr constant [37 x i8] c"a3f8ff4b-4e38-474d-b430-fc3105e34a5d\00", align 1
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [19 x i8] c"net.pvz.explodenut\00", align 1

;DSOCacheEntry
@.DSOCacheEntry.0_name = private unnamed_addr constant [12 x i8] c"libBugly.so\00", align 1
@.DSOCacheEntry.1_name = private unnamed_addr constant [15 x i8] c"libopenal32.so\00", align 1
...
@.DSOCacheEntry.11_name = private unnamed_addr constant [16 x i8] c"libMono.Unix.so\00", align 1
